 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation CreateReview($headline: String!, $name: String!, $email: String!, $content: String!, $rating: Int!, $slug: String!) {\n  createReview(\n    data: {headline: $headline, name: $name, email: $email, content: $content, product: {connect: {slug: $slug}}, rating: $rating}\n  ) {\n    id\n  }\n}"): typeof import('./graphql').CreateReviewDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetReviewsBySlug($slug: String!, $first: Int!, $skip: Int!) {\n  reviews(\n    where: {product: {slug: $slug}}\n    stage: DRAFT\n    orderBy: createdAt_DESC\n    first: $first\n    skip: $skip\n  ) {\n    content\n    name\n    rating\n    headline\n    createdAt\n    id\n    email\n  }\n  reviewsConnection(where: {product: {slug: $slug}}, stage: DRAFT) {\n    aggregate {\n      count\n    }\n  }\n}\n\nquery GetRatingBySlug($slug: String!) {\n  reviews(where: {product: {slug: $slug}}, stage: DRAFT) {\n    rating\n  }\n}\n\nquery CheckProductReviewByEmail($email: String!, $slug: String!) {\n  reviewsConnection(where: {email: $email, product: {slug: $slug}}, stage: DRAFT) {\n    aggregate {\n      count\n    }\n  }\n}"): typeof import('./graphql').GetReviewsBySlugDocument;
